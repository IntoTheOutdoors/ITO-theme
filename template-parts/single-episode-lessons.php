...
if(!empty($lesson_plans)): ?>
    ...
    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
        ...
        <?php
            ...
            ?>
                    <li>
                        <a class="dropdown-item" target="_blank" href="<?php echo $lesson_link; ?>"><i class="fas fa-arrow-down"></i><?php echo get_the_title($elementary->ID); ?></a>
                    </li>
                <?php
        ...
        <?php
            ...
            ?>
                    <li>
                        <a class="dropdown-item" target="_blank" href="<?php echo $lesson_link; ?>"><i class="fas fa-arrow-down"></i><?php echo get_the_title($middle_school->ID); ?></a>
                    </li>
                <?php
            endwhile;  wp_reset_postdata();
        endif;
        ...
        <?php
            ...
            ?>
                    <li>
                        <a class="dropdown-item" target="_blank" href="<?php echo $lesson_link; ?>"><i class="fas fa-arrow-down"></i><?php echo get_the_title($high_school->ID); ?></a>
                    </li>
                <?php
            endwhile;  wp_reset_postdata();
        endif;
